...
class User(Base):
    ...
    # Checks (permiso por feature)
    can_manage_catalogs: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)   # Sistema: turnos/jornadas/códigos
    can_manage_companies: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False) # crear/editar empresas/sucursales/OU
    ...
    can_edit_turnos: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)      # edición en cuadrante (mañana)
    can_view_all_runs: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False)    # super puede ver todo
